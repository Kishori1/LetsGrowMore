...
public class CurrencyConverter {
    ...
    public static void Ruppe_to_other(double amt) {
        ...
        System.out.println(amt + " Ruppe = " + (amt * 0.0113) + " Pound");
    }
    ...
    public static void Dollar_to_other(double amt) {
        ...
        System.out.println(amt + " Dollar = " + (amt * 0.78) + " Pound");
    }
    ...
    public static void Euro_to_other(double amt) {
        ...
        System.out.println(amt + " Euro = " + (amt * 0.90) + " Pound");
    }

    public static void Pound_to_other(double amt) {
        System.out.println(amt + " Pound= " + (amt * 88) + " Ruppe");
        System.out.println(amt + " Pound = " + (amt * 1.02) + " Dollar");
        System.out.println(amt + " Pound = " + (amt * 0.98) + " Euro");
    }
}